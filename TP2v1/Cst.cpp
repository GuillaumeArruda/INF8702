...
const int      CCst::noiseWidth      = 1000;           
const int      CCst::noiseHeight     = 624;              
...
const float    CCst::dispAmplitude1  = 4.0f;           
const float    CCst::dispAmplitude2  = 2.0f;              
const float    CCst::dispFrequency1  = 0.5f;              
const float    CCst::dispFrequency2  = 0.5f;   
