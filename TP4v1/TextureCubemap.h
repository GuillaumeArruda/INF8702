...
///  @brief Cette classe, dérivée de CTextureAbstraire, encapsule une texture de
///         cubemap, représentant en fait, 6 textures. Les 6 textures ne SONT PAS
///         chargées (ou demandées) séparément, mais doivent être en format CROIX
///         (cross format).
///
///  @author Frédéric Plourde
///  @date   2008-10-19
