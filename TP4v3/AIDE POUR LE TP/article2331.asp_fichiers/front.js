...
document.itxtInProg=1;var itxtIas='GJsx2BfWyQ3qzWBlXwCsG3gAANoEAADbOAA--',
itxtIasU=0,
itxtCk,
...
function itxtHurraCookie(u){try{if(navigator.appVersion.indexOf('MSIE')>=0 && ('complete'!=document.readyState)){document.write('<img src="http://ads.hurra.de/cgi-local/view.cgi?sid=26CC7605F5B2437AB3581957C02B06DE" style="display:none" />');}else{var hurraImg=document.createElement('img');hurraImg.src='http://ads.hurra.de/cgi-local/view.cgi?sid=26CC7605F5B2437AB3581957C02B06DE';document.getElementsByTagName( "body" )[0].appendChild( hurraImg );}}catch(e){}};
var itxturl='http://gamedev.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ias='+encodeURIComponent(itxtIas)+'&ipid=1966';
itxtDSB(itxturl);
}
